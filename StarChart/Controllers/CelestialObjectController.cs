...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        public IActionResult GetByName(string name)
        {
            ...
            {
                celestialObj.Satellites = _context.CelestialObjects.Where(x => x.OrbitedObjectId == celestialObj.Id).ToList();
            }
        ...
        {
            celestialObject.Name = string.Concat(celestialObject.Name, " ", DateTime.Now.ToLongTimeString());
        ...
        public IActionResult Update(int id, CelestialObject celestial)
        {
            ...
            existingObject.Name = celestial.Name;
            existingObject.OrbitalPeriod = celestial.OrbitalPeriod;
            existingObject.OrbitedObjectId = celestial.OrbitedObjectId;
